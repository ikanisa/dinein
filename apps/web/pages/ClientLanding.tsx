...
const ClientLanding: React.FC = () => {
  ...
  return (
    <PullToRefresh onRefresh={async () => { await refetch(); }} scrollContainerId="landing-content">
      <main id="landing-content" className="min-h-screen bg-background pt-safe-top pb-24 px-4 overflow-y-auto">
